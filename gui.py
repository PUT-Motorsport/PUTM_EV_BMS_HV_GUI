...
basic_info = [
    sg.Text("MAX VOLTAGE:"),
    sg.Text("", size=(10, 1), key="-VALUE1-"),
    sg.Text("MIN VOLTAGE:"),
    sg.Text("", size=(10, 1), key="-VALUE2-"),
    sg.Text("CURRENT:"),
    sg.Text("", size=(10, 1), key="-VALUE3-"),
    sg.Text("ACC VOLTAGE:"),
    sg.Text("", size=(10, 1), key="-VALUE4-"),
    sg.Text("CAR VOLTAGE:"),
    sg.Text("", size=(10, 1), key="-VALUE5-"),
    sg.Text("SOC:"),
    sg.Text("", size=(10, 1), key="-VALUE6-"),
    sg.Text("AIR:"),
    sg.Text("", size=(10, 1), key="-VALUE7-"),
    sg.Text("CHARGER CURRENT:"),
    sg.Text("", size=(10, 1), key="-VALUE8-"),
    sg.Text("CHARGER VOLTAGE:"),
    sg.Text("", size=(10, 1), key="-VALUE9-"),
]
voltage_matrix = [["-" for row in range(15)] for col in range(9)]
voltage = [
    sg.Table(
        values=voltage_matrix,
